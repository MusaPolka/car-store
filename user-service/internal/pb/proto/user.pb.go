...
const file_proto_user_proto_rawDesc = "" +
	...
	".user.UserR\x05users2K\n" +
	"\vUserService\x12<\n" +
	"\tListUsers\x12\x16.user.ListUsersRequest\x1a\x17.user.ListUsersResponseB'Z%ecommerce/user-service/internal/pb;pbb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	...
	2, // 2: user.UserService.ListUsers:output_type -> user.ListUsersResponse
